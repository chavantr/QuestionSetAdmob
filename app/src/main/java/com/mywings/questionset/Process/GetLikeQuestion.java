 ...
 */
public class GetLikeQuestion extends AsyncTask<String, Void, ObservableArrayList<Question>> {



    public OnLikeQuestionsListener onLikeQuestionsListener;
    private Exception exception = null;
    private MyDatabase db;

    public GetLikeQuestion(MyDatabase db) {
        this.db = db;
    }
    ...
    protected ObservableArrayList<Question> doInBackground(String... params) {
        ...
        Cursor mCursor = db.getQuestionSetLike(params[0]);
    ...
    protected void onPostExecute(ObservableArrayList<Question> questions) {
        ...
        onLikeQuestionsListener.onLikeQuestionComplete(questions,exception);
    }


    public void setOnLikeQuestionsListener(OnLikeQuestionsListener onLikeQuestionsListener) {
        this.onLikeQuestionsListener = onLikeQuestionsListener;
    }
